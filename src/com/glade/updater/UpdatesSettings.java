/*
 * Copyright (C) 2015 The Glade Project (DvTonder)
 *
...
import com.glade.updater.service.UpdateCheckService;
import com.glade.updater.utils.UpdateFilter;
...
public class UpdatesSettings extends PreferenceActivity implements
    ...
    private void refreshPreferences(LinkedList<UpdateInfo> updates) {
        ...
        String installedZip = "Glade-" + Utils.getInstalledVersion() + ".zip";
