/*
 * Copyright (C) 2015 The Glade Project
 *
...
package com.glade.updater.service;
...
import com.glade.updater.R;
import com.glade.updater.UpdateApplication;
import com.glade.updater.requests.UpdatesJsonObjectRequest;
import com.glade.updater.UpdatesSettings;
import com.glade.updater.misc.Constants;
import com.glade.updater.misc.State;
import com.glade.updater.misc.UpdateInfo;
import com.glade.updater.receiver.DownloadReceiver;
import com.glade.updater.utils.Utils;
...
public class UpdateCheckService extends IntentService
    ...
    // request actions
    public static final String ACTION_CHECK = "com.glade.gladeupdater.action.CHECK";
    public static final String ACTION_CANCEL_CHECK = "com.glade.gladeupdater.action.CANCEL_CHECK";

    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.glade.gladeupdater.action.UPDATE_CHECK_FINISHED";
    ...
    private URI getServerURI() {
        String propertyUpdateUri = SystemProperties.get("glade.updater.uri");
    ...
    private JSONObject buildUpdateRequest(int updateType) throws JSONException {
        ...
        params.put("device", TESTING_DOWNLOAD ? "gladetestdevice" : Utils.getDeviceType());
