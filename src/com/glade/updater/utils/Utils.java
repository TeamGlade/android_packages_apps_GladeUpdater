...
package com.glade.updater.utils;
...
public class Utils {
    ...
    public static String getDeviceType() {
        return SystemProperties.get("ro.glade.device");
    }

    public static String getInstalledVersion() {
        return SystemProperties.get("ro.glade.version");
    }
    ...
    private static String getStorageMountpoint(Context context) {
        ...
        for (int i = 0; i < volumes.length; i++) {
            ...
            if (v.getPath().equals(primaryStoragePath)) {
                 ...
                 *
                 * For Glade, a non-removable storage (partition or FUSE)
